module Infra.Beam.Schema.Entity.User.V1
  ( UserEntityT(..)
  , UserEntity
  , UserEntityId
...
mkUsersTable :: Migration Postgres (CheckedDatabaseEntity Postgres db (TableEntity UserEntityT))
mkUsersTable = createTable
  "users"
